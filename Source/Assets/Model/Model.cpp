...
std::vector<ModelDescription> Model::getModelDescriptions() const
{
    ...
    model_description.vertex_buffer_address = vertex_buffer->getBufferDeviceAddress();
    model_description.index_buffer_address = index_buffer->getBufferDeviceAddress();
