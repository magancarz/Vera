...
{
public:
    RayTracingPipelineBuilder(VulkanFacade& device, std::unique_ptr<MemoryAllocator>& memory_allocator, VkPhysicalDeviceRayTracingPipelinePropertiesKHR ray_tracing_properties);
